        ...
        <>
            <div className='text-center mb-3'>
                ...
                <div className="container form">
                    <p className="text-center my-3"><i>New to HabiTrack? 👉🏻Create a new account here! </i></p>
                ...
                <div className='text-center'>
                    <button type="submit" className='btn btn-dark' onClick={handleClick}>SignUp</button>
                </div>
                <br />
